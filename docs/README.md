...
Contributors should review the [Repository Guidelines](AGENTS.md) for project structure, coding standards, and agent configuration practices before making changes.
...
If you're new to the project, start with the simple Hello World script:
...
**Purpose**: `hello_world.py` is a simple demonstration script that prints "Hello, World!" to the console. It serves as a basic example of a Python script in this project.

**Usage**: Simply execute the script with Python 3:
```bash
python3 hello_world.py
# Output: Hello, World!
```
