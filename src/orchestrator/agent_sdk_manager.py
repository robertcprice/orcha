...
except ModuleNotFoundError:  # pragma: no cover - anthopic optional during tests
    anthropic = None
    Message = TextBlock = ToolUseBlock = MessageParam = MessageStreamEvent = Any
...
class AgentSDKManager:
    ...
    def __init__(
        ...
        if anthropic is None:
            raise RuntimeError(
                "The 'anthropic' package is required to create AgentSDKManager instances."
            )
