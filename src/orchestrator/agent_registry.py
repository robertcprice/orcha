...
class AgentRegistry:
    ...
    def _register_specialist_agents(self):
        ...
        self._agents["SECURITY"] = AgentRole(
            role="SECURITY",
            ...
            system_prompt_file="agents/specialists/SECURITY_SYSTEM.md",
            temperature=0.4
        )

        # Debugger Agent (DEBUGGER)
        self._agents["DEBUGGER"] = AgentRole(
            role="DEBUGGER",
            name="Debugger Agent",
            description="Analyzes failing tests, stack traces, and proposes automated fixes",
            capabilities=[
            ...
            system_prompt_file="agents/specialists/DEBUGGER_SYSTEM.md",
            temperature=0.7
        )
...
class AgentFactory:
    ...
    def recommend_agent(self, task_description: str) -> List[str]:
        ...
        keywords_to_agents = {
            ...
            "SECURITY": ["security", "vulnerability", "owasp", "audit", "scan"],
            "DEBUGGER": ["stack trace", "traceback", "test failure", "error log", "debug"],
